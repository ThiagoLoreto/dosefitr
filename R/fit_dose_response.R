...
#' @param r_sqr_threshold Numeric value between 0 and 1 specifying the R2 cutoff
...
#' @importFrom grDevices colorRampPalette rainbow heat.colors terrain.colors topo.colors cm.colors
#' @export
